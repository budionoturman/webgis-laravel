...
@section('container')
  ...
  <a href="/dashboard/users/create"><span class="btn btn-success mb-3"><i class="bi bi-pencil-square"> Tambah Users</i></span></a>
                  ...
                  @foreach ($users as $user) 
                      <tr>
                          ...
                          <td>
                              ...
                              <a href="/dashboard/users/{{ $user->id }}/edit"><button class="btn btn-warning btn-sm mt-1"><i class="bi bi-pencil-square"> Edit</i></button></a>
