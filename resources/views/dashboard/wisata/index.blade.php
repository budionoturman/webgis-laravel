...
@section('container')
    ...
    @endif
    <a href="/dashboard/wisatas/create"><span class="btn btn-success mb-3"><i class="bi bi-pencil-square"> Tambah
                Wisata</i></span></a>
                    ...
                    <tbody>
                        @foreach ($wisata as $w)
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/wisatas/{{ $w->id }}"><button
                                            class="btn btn-info btn-sm mt-1"><i class="bi bi-eye"> Lihat</i></button></a>
                                    <a href="/dashboard/wisatas/{{ $w->id }}/edit"><button
                                            class="btn btn-warning btn-sm mt-1"><i class="bi bi-pencil-square">
                                                Edit</i></button></a>

                                    <form action="/dashboard/wisatas/{{ $w->id }}" method="post" class="d-inline">
                                        @csrf
                                        @method('delete')
